...
cls
echo =================================================================
echo    Hamsterdam BOT SETUP AND RUN SCRIPT
echo =================================================================
echo.
...
if not exist configs.json (
    ...
    echo   "isSpin": true,>> configs.json
    echo   "howMany2048Games": 10,>> configs.json
    echo   "delayEachAccount": [5, 8],>> configs.json
    echo   "countdown": 300,>> configs.json
    echo   "limit": 100,>> configs.json
    echo   "isDoTasks": true,>> configs.json
    echo   "isClaimAchievements": true,>> configs.json
    echo   "isBuyHamsters": true>> configs.json
    echo }>> configs.json
